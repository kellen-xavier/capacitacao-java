...
public class Pedido {
    ...
    public static void adicionaItemNaLista(Produto produto, int quantidade) {
        if (Estoque.darBaixaEmEstoque(produto.getNome(), quantidade)) {
            for (Item item : listaDeItens) {
            ...
            System.out.println("Verifique o catálogo disponível em estoque.");
        }
    }
